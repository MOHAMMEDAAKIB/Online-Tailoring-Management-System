    ...
    return (
        <header className="my-measurements-navbar">
            <div className="my-measurements-navbar-content">
                <div className="my-measurements-navbar-brand">
                    ...
                    <h2 className="my-measurements-navbar-title">TailorFlow</h2>
                </div>
                <div className="my-measurements-navbar-actions">
                    <nav className="my-measurements-navbar-nav">
                        <a className="my-measurements-navbar-link" href="#">Dashboard</a>
                        <a className="my-measurements-navbar-link" href="#">My Orders</a>
                        <a className="my-measurements-navbar-link active" href="#">My Measurements</a>
                        <a className="my-measurements-navbar-link" href="#">Settings</a>
                    </nav>
                    <button className="my-measurements-navbar-button">
