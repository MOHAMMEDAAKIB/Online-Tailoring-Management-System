...
function TrackOrderFooter() {
    return (
        <footer className="track-order-footer">
            <div className="track-order-footer-content">
                <div className="track-order-footer-social">
                    <a className="track-order-footer-social-link" href="#">
                        <span className="sr-only">Facebook</span>
                        <svg className="track-order-footer-icon" fill="currentColor" viewBox="0 0 24 24">
                ...
                <nav className="track-order-footer-nav">
                    <div className="track-order-footer-nav-item">
                        <a className="track-order-footer-link" href="#">About</a>
                    </div>
                    <div className="track-order-footer-nav-item">
                        <a className="track-order-footer-link" href="#">FAQ</a>
                    </div>
                    <div className="track-order-footer-nav-item">
                        <a className="track-order-footer-link" href="#">Contact Us</a>
                    </div>
                </nav>
                <p className="track-order-footer-copyright">
                    © 2023 Bespoke Tailoring. All rights reserved.
                </p>
            </div>
        </footer>
    );
